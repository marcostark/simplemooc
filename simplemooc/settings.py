...
SECRET_KEY = '8i#b9$es$fp6$n=2hb%85z3n-z4kcbn^648)+a*9vm-v(0_*+9'
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' #Apena teste, o django ira imprimir na tela a mensagem
DEFAULT_FROM_EMAIL = 'Nome <marc@email.com>'
EMAIL_USE_TLS = 'True'
...
#Importante colocar as constantes do projetos todas aqui no settings.py
#Assim ficará acessivél em toda a aplicação
